...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserList = channel.unary_unary(
                ...
                request_serializer=user__pb2.NoUserMessage.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserList': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.NoUserMessage.FromString,
...
class UserService(object):
    ...
    def GetUserList(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UserService/GetUserList',
            user__pb2.NoUserMessage.SerializeToString,
